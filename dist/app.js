...
const message_routes_1 = __importDefault(
  require("./modules/message/message.routes")
);
const friend_routes_1 = __importDefault(
  require("./modules/friend/friend.routes")
);
const email_routes_1 = __importDefault(
  require("./modules/reset-password/email.routes")
);
